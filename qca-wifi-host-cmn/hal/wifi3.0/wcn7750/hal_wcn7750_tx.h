...
/**
 * hal_tx_set_dscp_tid_map_7750() - Configure default DSCP to TID map table
 ...
 * Return: none
 */
static void hal_tx_set_dscp_tid_map_7750(struct hal_soc *hal_soc, uint8_t *map,
					 uint8_t id)
{
	int i;
...
/**
 * hal_tx_update_dscp_tid_7750() - Update the dscp tid map table as updated
 *					by the user
 * @hal_soc: HAL SoC context
 * @tid: TID
 * @id : MAP ID
 ...
 * Return: void
 */
static void hal_tx_update_dscp_tid_7750(struct hal_soc *hal_soc, uint8_t tid,
...
/**
 * hal_tx_init_cmd_credit_ring_7750() - Initialize command/credit SRNG
 ...
 */
static inline void
hal_tx_init_cmd_credit_ring_7750(hal_soc_handle_t hal_soc_hdl,
...
/**
 * hal_tx_config_rbm_mapping_be_7750() - Update return buffer manager ring id
 ...
 */
static inline void
hal_tx_config_rbm_mapping_be_7750(hal_soc_handle_t hal_soc_hdl,
				  hal_ring_handle_t hal_ring_hdl,
				  uint8_t rbm_id)
{
