...
#ifndef _HAL_QCC2072_RX_H_
#define _HAL_QCC2072_RX_H_
#include "qdf_util.h"
#include "qdf_types.h"
#include "qdf_lock.h"
#include "qdf_mem.h"
...
static inline
void hal_rx_get_bb_info_2072(void *rx_tlv,
			     void *ppdu_info_hdl)
{
...
static inline
void hal_rx_get_rtt_info_2072(void *rx_tlv,
			      void *ppdu_info_hdl)
{
	struct hal_rx_ppdu_info *ppdu_info  = ppdu_info_hdl;
	...
	ppdu_info->cfr_info.agc_gain_info0 |=
	(((uint32_t)HAL_RX_GET(rx_tlv, PHYRX_LOCATION_RX_LOCATION_INFO_DETAILS,
			       GAIN_CHAIN1)) << 16);
